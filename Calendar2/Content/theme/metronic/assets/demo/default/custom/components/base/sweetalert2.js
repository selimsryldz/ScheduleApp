...
function newFunction() {
    var SweetAlert2Demo = {
        init: function() {
            $("#m_sweetalert_demo_1").click(function(e) { swal("Good job!"); }),
                $("#m_sweetalert_demo_2").click(function(e) { swal("Here's the title!", "...and here's the text!"); }),
                $("#m_sweetalert_demo_3_1").click(function(e) {
                    swal("Good job!", "You clicked the button!", "warning");
                }),
                $("#m_sweetalert_demo_3_2")
                    .click(function(e) { swal("Good job!", "You clicked the button!", "error"); }),
