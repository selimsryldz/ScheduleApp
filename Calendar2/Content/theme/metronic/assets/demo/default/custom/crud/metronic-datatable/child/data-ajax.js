    ...
    init: function() {
        $(".m_datatable").mDatatable({
            data:
            {
                type: "remote",
                source: {
                    read: { url: "https://keenthemes.com/metronic/preview/inc/api/datatables/demos/customers.php" }
                },
                pageSize: 10,
                serverPaging: !0,
                serverFiltering: !1,
            ...
            detail: {
                ...
                content: function(t) {
                    $("<div/>").attr("id", "child_data_ajax_" + t.data.RecordID).appendTo(t.detailCell).mDatatable({
                        ...
                        sortable: !0,
                        columns: [
                            { field: "RecordID", title: "#", sortable: !1, width: 20, responsive: { hide: "xl" } },
                            {
                                field: "OrderID",
                                title: "Order ID",
                                template: function(t) {
                            ...
                            { field: "ShipAddress", title: "Ship Address" }, { field: "ShipName", title: "Ship Name" },
            ...
            columns: [
                { field: "RecordID", title: "", sortable: !1, width: 20, textAlign: "center" },
                {
                    field: "checkbox",
                    title: "",
                    template: "{{RecordID}}",
                ...
                { field: "LastName", title: "Last Name" }, { field: "Company", title: "Company" },
                { field: "Email", title: "Email" }, { field: "Phone", title: "Phone" }, {
                    field: "Status",
                    title: "Status",
                    template: function(t) {
                        var e = {
